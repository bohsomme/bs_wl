...
export const translations = {
  ...
  no: {
    ...
    option1Price: "250 NOK",
    option1Period: "/ mnd",
    option1Description: "Få tilgang til det strukturerte BS-WL vektløftingsprogrammet med direkte kontakt med coach.",
    option1Feature1: "3- eller 4-dagers vektløftingsprogram per uke",
    option1Feature2: "Chat med coach",
    option1Feature3: "Videogjennomgang av løft",
    ...
    option2Feature2: "Månedlig blokkgjennomgang og planleggingsøkt",
    option2Feature3: "Chat med coach",
    option2Feature4: "Videogjennomgang av løft",
